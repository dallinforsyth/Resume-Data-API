...
json.experiences student.experiences.map do |experience|
...
json.educations student.educations.map do |education|
...
json.capstones student.capstones.map do |capstone|
